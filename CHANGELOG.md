...
- fix: appweaver logo to use cyan version for PWA (0e0ecfc4)

## [v12.8.2] - 2026-09-15

- fix: added appweaver fixed version tag for cloning in alpine dockerfile (3e4b4139)

## [v12.8.1] - 2026-09-14

- fix: made alpine docker image and dependencies fixed (28ef614f)
...
- fix: donations@getappweaver.com redirect to dhalsim@blink.sv was failing (872972d8)
...
- fix: edit tool output to patch card (7cff67aa)
...
- fix: plugins install widget version mismatch with v prefix, also repo match of npub vs nip05 (4b2f1fa1)
...
- fix: archive button update (209063b4)
...
- fix: todo card rendering (5225864e)
